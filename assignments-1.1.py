...
out2 = tf.case({tf.less(x,y): lambda: tf.add(x, y), tf.greater(x, y): lambda: tf.subtract(x, y)}, default=lambda:tf.constant(0,dtype=tf.float32), exclusive=True)
print(sess.run(out2))
###############################################################################
...
indice = tf.where(tf.greater(x, 30))
out4 = tf.gather(x, indice)
print(sess.run(out4))
###############################################################################
...
###############################################################################
# YOUR CODE
out6 = tf.matrix_determinant(tf.random_uniform([10,10]))
print(sess.run(out6))
###############################################################################
...
###############################################################################
# YOUR CODE
out7 = tf.unique(tf.constant([5, 2, 3, 5, 10, 6, 2, 3, 4, 2, 1, 1, 0, 9]))
print(sess.run(out7))
###############################################################################
